...
<div class="d-flex justify-content-center">
    <div class="col-md-10 card card-info card-outline card-tabs">
        <div class="card-header">
            <h3 class="card-title"> <a href="{{route('tag.create')}}"> <button type="button" class="btn btn-info">Create
                        new</button></a> </h3>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="btn-group btn-group-toggle">
                            <a class="btn btn-primary btn-xs mr-1" href="{{route('tag.edit',$tag->id) }}"> <i
