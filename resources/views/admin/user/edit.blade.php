...
<div class="row">
    <div class="card col-md-12">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                placeholder="Name" value="{{ ucfirst($user->name) }}" name="name" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <input type="email" class="form-control  @error('email') is-invalid @enderror" name="email"
                                id="" aria-describedby="helpId" placeholder="Enter Email"
                                value="{{ucfirst($user->email)}}" required>
                            <div class="invalid-feedback">
                                Field is required
                            </div>
                            @error('email')
        ...
        <div id="avatar">
            ...
            <div id="avatar" class="">
                <div class="p-4 border-top">
                    <form role="form" class="card-body  needs-validation" action="{{route('changeavatar',$user->id)}}"
                        method="post" enctype="multipart/form-data" novalidate id="selectform{{$user->id}}">
                        @csrf
                        @method('put')
                        <div class="mb-3 row align-items-center">
